...
@section('content')
    ...
    <form action="{{ route('paintings.update', $painting) }}" method="POST" enctype="multipart/form-data" data-painting-form class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
        @csrf
        @method('PUT')
