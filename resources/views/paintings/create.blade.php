...
@section('content')
    <div class="max-w-3xl mx-auto">
        ...
        <form action="{{ route('paintings.store') }}" method="POST" enctype="multipart/form-data" data-painting-form class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 lg:p-8">
            @csrf
